...
export default async function DashboardPage() {
  ...
  return (
    <main className="min-h-screen bg-[#FAF7F1] p-10">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-10">
          ...
          <div>
            <h1 className="text-5xl font-black text-[#285C5F]">
              Admin Control
            </h1>
...
function StatCard({
  ...
  return (
    <div className="bg-white rounded-2xl shadow-lg px-8 py-5 min-w-[150px]">
